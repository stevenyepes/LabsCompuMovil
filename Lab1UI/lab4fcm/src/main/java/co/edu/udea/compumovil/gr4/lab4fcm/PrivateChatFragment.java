...
public class PrivateChatFragment extends Fragment {
    ...
    public void onStart() {
        ...
        if (randomUser.equals(user) || randomUser.equals(receiver)){
            Log.d("private", "entra al if");
            ...
            Log.d("private2", "sale del if");
            pChatList.setAdapter(adapter);
            Log.d("private3", "adapter done");
        }else {
            Toast.makeText(getContext(), "User don't allowed", Toast.LENGTH_SHORT).show();
        }

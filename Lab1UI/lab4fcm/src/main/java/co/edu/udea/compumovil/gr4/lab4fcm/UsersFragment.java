...
public class UsersFragment extends Fragment {
    ...
    public void onStart() {
        ...
        final FirebaseRecyclerAdapter<User, MessageViewHolder> adapter =
            ...
            @Override
            protected void populateViewHolder(final MessageViewHolder viewHolder, final User model, final int position) {
                ...
                viewHolder.mUser.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        args.putString("receiver",getRef(position).getKey());
